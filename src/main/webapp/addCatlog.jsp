	...
	$.ajax({
		...
		success : function(data,textStatus, jqXHR) {
			...
			$.each($.parseJSON(data),function(id,value) {
				...
				alert(value.price);
				document.getElementById("demo").innerHTML =value.price;
 ...
 */
	//		}
			//alert("obj is company name "+obj.companyName+" product name "+productName+ " price "+price+" quantity "+quantity );
			/*
			for(var i=0;i<obj.length;i++){
			     alert(obj[i]["companyName"].type);
			}
			*/
